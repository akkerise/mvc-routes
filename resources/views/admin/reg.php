<?php include '_admin_template/header.php' ?>
    ...
    <div class="register-box">
        <div class="register-logo">
            <a href="<?php echo BASE_PATH; ?>"><b>Thanh's</b> Blog</a>
        </div>

        <div class="register-box-body">
            <p class="login-box-msg">Đăng kí làm thành viên ( thực ra là đăng kí làm admin luôn đấy)</p>

            <form action="<?php echo BASE_PATH; ?>/admin/reg/check" method="post">
                ...
                <div class="form-group has-feedback">
                    <input type="password" class="form-control" placeholder="Password"
                           name="password"
                           value="<?php echo isset($_SESSION['input']['old_password']) ? $_SESSION['input']['old_password'] : null; ?>">
                ...
                <div class="row">
                    <div class="col-xs-8">
                        <a href="<?php echo BASE_PATH; ?>/admin/log" class="text-center">Có tài khoản thì bấm vào đây</a>
                    </div>
                    <!-- /.col -->
                    <div class="col-xs-4">
